...
MODEL_PATH1 = r"/home/calvin/Documents/NNDL/Models/irv2_all_40.h5"
MODEL_PATH2 = r"/home/calvin/Documents/NNDL/Models/irv2_all_20.h5"
...
test_steps = int(np.floor(test_data_flow3.n/BATCH_SIZE))+1
#test_steps = 10
image_ID3 = test_data_flow3.filenames
predicted_results3 = model3.predict_generator(test_data_flow3, steps=test_steps, verbose = 1)

test_datagen4 = image.ImageDataGenerator(preprocessing_function=preprocess_input)
#generate batches of data for training
test_data_flow4 = test_datagen4.flow_from_directory(
        directory = TEST_DIR,
        target_size = (IMG_H, IMG_W),
        class_mode = None,
        batch_size = BATCH_SIZE,
...
test_steps = int(np.floor(test_data_flow4.n/BATCH_SIZE))+1
#test_steps = 10
image_ID4 = test_data_flow4.filenames
predicted_results4 = model4.predict_generator(test_data_flow4, steps=test_steps, verbose = 1)
'''
